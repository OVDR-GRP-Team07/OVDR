...
|---------------------------|---------------------------------------------------------------------------------------------------------------------------|--------------------------------|
| **Zhihao Cao**            | Group leader,frontend development, Backend architecture, StableVITON try-on module, combination generation and recording, bug fixing, Installation Manual, Final Report          | scyzc10@nottingham.edu.cn         |
